...
REM     This script file creates the following tables: VENDOR, PRODUCT, CUSTOMER, INVOICE, LINE, EMPLOYEE and loads the default data rows		  		 
...
CONSTRAINT INV_CK1 CHECK (INV_DATE > TO_DATE('01-JAN-2019','DD-MON-YYYY')));
...
REM Notice we can't include a FK constraint in EMPLOYEE to reference itself because we still have not created the table. This has to be done separately as shown below		 
...
INSERT INTO VENDOR VALUES(21226,'SuperLoom, Inc.'  ,'Flushing','904','215-8995','FL','N');

INSERT INTO VENDOR VALUES(21231,'D n E Supply'     ,'Singh'   ,'615','228-3245','TN','Y');

INSERT INTO VENDOR VALUES(21344,'Gomez Brothers'     ,'Ortega'  ,'615','889-2546','KY','N');

INSERT INTO VENDOR VALUES(22567,'Dome Supply'     ,'Smith'   ,'901','678-1419','GA','N');

INSERT INTO VENDOR VALUES(23119,'Randsets Limited'   ,'Anderson','901','678-3998','GA','Y');

INSERT INTO VENDOR VALUES(24004,'Brackman Brothers'  ,'Browning','615','228-1410','TN','N');

INSERT INTO VENDOR VALUES(24288,'ORDVA Inc.'     ,'Hakford' ,'615','898-1234','TN','Y');

INSERT INTO VENDOR VALUES(25443,'B and K, Inc.'      ,'Smith'   ,'904','227-0093','FL','N');

INSERT INTO VENDOR VALUES(25501,'Damal Supplies'  ,'Smythe'  ,'615','890-3529','TN','N');

INSERT INTO VENDOR VALUES(25595,'Rubi Systems' ,'Orton'   ,'904','456-0092','FL','Y');
...
INSERT INTO PRODUCT VALUES('1546-QQ2','Hrd. cloth, 14-in., 2x50'             ,'15-JAN-2012', 15,  8, 39.95,0.00,23119);

INSERT INTO PRODUCT VALUES('1558-QW1','Hrd. cloth, 12-in., 3x50'             ,'15-JAN-2012', 23,  5, 43.99,0.00,23119);
...
INSERT INTO PRODUCT VALUES('2238/QPD','BD cordless drill, 12-in.'            ,'20-JAN-2012', 12,  5, 38.95,0.05,25595);
...
INSERT INTO PRODUCT VALUES('54778-2T','Rat-tail file, 18-in. fine'           ,'15-DEC-2011', 43, 20,  4.99,0.00,21344);
...
INSERT INTO PRODUCT VALUES('WR3/TT3' ,'Steel, 4x8x16, .5 mesh'               ,'17-JAN-2012', 18,  5,119.95,0.10,25595);
...
INSERT INTO CUSTOMER VALUES(10019,'Smith'   ,'Olivette','K' ,'615','297-3809',0);

REM INVOICE rows 


INSERT INTO INVOICE VALUES(1001,10014,'16-JAN-2019');

INSERT INTO INVOICE VALUES(1002,10011,'16-JAN-2019');

INSERT INTO INVOICE VALUES(1003,10012,'16-JAN-2019');

INSERT INTO INVOICE VALUES(1004,10011,'17-JAN-2019');

INSERT INTO INVOICE VALUES(1005,10018,'17-JAN-2019');

INSERT INTO INVOICE VALUES(1006,10014,'17-JAN-2019');

INSERT INTO INVOICE VALUES(1007,10015,'17-JAN-2019');

INSERT INTO INVOICE VALUES(1008,10011,'17-JAN-2019');
...
INSERT INTO EMPLOYEE VALUES(107,'Mr.' ,'Diantee'    ,'Jorge'  ,'D' ,'21-AUG-1974','02-JUL-1994','615','890-4567',105);

INSERT INTO EMPLOYEE VALUES(108,'Mr.' ,'Wiesenbach','Paul'   ,'R' ,'14-FEB-1966','18-NOV-1992','615','897-4358',NULL);

INSERT INTO EMPLOYEE VALUES(109,'Mr.' ,'Smith'     ,'George' ,NULL,'18-JUN-1961','14-APR-1989','901','504-3339',108);
...
INSERT INTO EMPLOYEE VALUES(116,'Mr.' ,'Smith'     ,'Michael' ,'A' ,'08-NOV-1965','10-DEC-1988','615','890-2984',108);
